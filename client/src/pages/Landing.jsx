...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#0b1c30] font-sans antialiased selection:bg-[#0058be] selection:text-white">
      {/* 1. Attached Sticky Top Navigation Header (Narrow Width & Rounded Bottom) */}
      <div className="sticky top-0 z-40 w-full flex flex-col items-center pointer-events-none px-4">
        <header className="w-full max-w-5xl bg-white/95 backdrop-blur-md border-x border-b border-[#e2e8f0] rounded-b-2xl sm:rounded-b-3xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] px-5 sm:px-7 h-15 sm:h-16 flex items-center justify-between pointer-events-auto transition-all">
          {/* Brand Logo */}
          ...
          <nav className="hidden lg:flex items-center gap-6 text-xs font-medium text-[#475569]">
            <a
              href="#simulator"
              onClick={() => setActiveNav('simulator')}
              className={`transition-colors cursor-pointer hover:text-[#0b1c30] ${
                activeNav === 'simulator' ? 'text-[#0b1c30] font-bold' : ''
              }`}
            >
              Simulator
            </a>
            ...
            <a
              ...
              className={`transition-colors cursor-pointer hover:text-[#0b1c30] ${
                activeNav === 'architecture' ? 'text-[#0b1c30] font-bold' : ''
              }`}
            >
              Architecture
            </a>
            ...
            <a
              ...
              className={`transition-colors cursor-pointer hover:text-[#0b1c30] ${
                activeNav === 'features' ? 'text-[#0b1c30] font-bold' : ''
              }`}
            >
              Features
            </a>
            ...
            <a
              ...
              className={`transition-colors cursor-pointer hover:text-[#0b1c30] ${
                activeNav === 'comparison' ? 'text-[#0b1c30] font-bold' : ''
              }`}
            >
              Why Pravaah
            </a>
            ...
            <Link
              ...
              className={`transition-colors cursor-pointer hover:text-[#0b1c30] ${
                activeNav === 'docs' ? 'text-[#0b1c30] font-bold' : ''
              }`}
            >
              Docs
            </Link>
          ...
          <div className="hidden md:flex items-center gap-3.5 shrink-0">
            <Link
              to="/dashboard"
              className="text-xs font-semibold text-[#475569] hover:text-[#0b1c30] transition-colors px-2 py-1 flex items-center gap-1.5"
            >
            ...
            <button
              ...
              className="rounded-full bg-[#0b1c30] hover:bg-black text-white px-5 py-2 text-xs font-semibold shadow-xs active:scale-[0.98] transition-all cursor-pointer"
            >
              Start Your Flow
            </button>
          </div>
          ...
          <button
            ...
            className="md:hidden p-2 rounded-lg text-[#76777d] hover:text-[#0b1c30] hover:bg-slate-100"
        ...
        {mobileMenuOpen && (
          <div className="md:hidden w-full max-w-5xl mt-1.5 bg-white border border-[#e2e8f0] rounded-2xl p-4 flex flex-col gap-1.5 shadow-xl animate-fadeIn pointer-events-auto">
            <a
              href="#simulator"
              onClick={() => setMobileMenuOpen(false)}
              className="text-xs font-semibold text-[#45464d] hover:text-[#0058be] flex items-center gap-2.5 px-3 py-2 rounded-xl hover:bg-slate-50"
            >
            ...
            <Link
              to="/dashboard"
              onClick={() => setMobileMenuOpen(false)}
              className="text-xs font-bold text-[#0058be] flex items-center gap-2.5 px-3 py-2 rounded-xl bg-slate-50"
            >
              <LayoutDashboard className="w-4 h-4" />
              <span>Command Center</span>
            </Link>

            <div className="pt-2 border-t border-[#e2e8f0] flex flex-col gap-2 mt-1">
              <button
                type="button"
                className="rounded-full bg-[#0b1c30] hover:bg-black text-white w-full py-2.5 text-xs font-semibold shadow-xs"
                onClick={() => {
      ...
      {/* 2. Hero Section */}
      <section className="relative pt-4 sm:pt-6 md:pt-8 pb-16 md:pb-24 overflow-hidden bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <RevealOnScroll delay={150}>
              <Card variant="interactive" className="p-6 flex flex-col justify-between bg-white border-[#e5eeff] hover:border-[#0058be] h-full">
                <div>
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 font-sans bg-white">
        <RevealOnScroll direction="up" duration={800}>
      ...
      <RevealOnScroll direction="up" duration={700}>
        <footer className="py-12 bg-white text-xs text-[#45464d] font-sans">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
