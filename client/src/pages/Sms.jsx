...
export default function Sms() {
  return (
    <div className="flex flex-col gap-6 max-w-5xl mx-auto animate-fadeIn font-sans selection:bg-[#0058be] selection:text-white pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-[#e2e8f0]">
        <div>
          ...
          <p className="mt-1 text-xs sm:text-sm text-[#64748b]">
            Customers can text your business number — your AI agent replies automatically.
          </p>
        </div>
        ...
        <div className="p-4 rounded-xl bg-[#fffbeb] border border-[#fef3c7] text-[#92400e] flex items-start gap-3 text-xs leading-relaxed">
          ...
          <div>
            ...
            <p className="mt-0.5 text-[#b45309]">
              SMS integration requires a registered phone number through a provider like Twilio. This channel isn't live yet — check back soon.
            </p>
          </div>
        </div>

        {/* Assigned SMS Number Box */}
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-semibold text-[#64748b]">Assigned SMS Number</label>
      ...
      {/* 3. Recent SMS Conversations (Static Empty State) */}
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#64748b]">
                Inbound customer text messages and AI replies
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-12 text-center flex flex-col items-center justify-center gap-2.5">
          ...
          <div className="max-w-md">
            ...
            <p className="text-xs text-[#64748b] mt-1 leading-relaxed">
              Once SMS is connected, incoming text messages will appear here.
            </p>
          </div>
        </div>
      </div>
